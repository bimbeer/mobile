...
class LocationFormInputs extends StatefulWidget {
  const LocationFormInputs({super.key});

  @override
  State<LocationFormInputs> createState() => _LocationFormInputsState();
}

class _LocationFormInputsState extends State<LocationFormInputs> {
  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        errorText: location.isPure ? null : location.error?.message,
